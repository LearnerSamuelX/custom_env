...
def make_env():
    env = gym.make("NewEnvBipedal_angular-V0")
    return env
...
run = wandb.init(
    ...
    monitor_gym=True,
    name="sam_PPO_" + SUFFIX + "_custom_no_stop_threshold_h8k12",
    save_code=True,
)
...
PPO_path = os.path.join("training", "saved_models", "NewBipedalWalker_final_custom_no_stop_thres_h8k12")
model.save(PPO_path)
